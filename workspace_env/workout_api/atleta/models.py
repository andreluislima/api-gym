...
from workspace_env.workout_api.categorias.models import CategoriaModel
from workspace_env.workout_api.centro_treinamento.models import CentroTreinamentoModel
